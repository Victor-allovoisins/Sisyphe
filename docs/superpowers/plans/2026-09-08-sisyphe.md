...
const verify: VerifyResult = {
  ok: true, noChanges: false, treeSha: 'a'.repeat(40), failedStep: null, failureTail: '', files: ['A.swift'], changedLines: 900,
...
const verifyBase: Omit<VerifyResult, 'treeSha'> = { ok: true, noChanges: false, steps: [], failedStep: null, failureTail: '', files: [], changedLines: 1, flags: { protectedPathsTouched: [], largeDiff: false, secretsFound: [] } };
